    ...
    return employees.map(emp => {
      ...
      const mapped = records.map(r => {
        ...
        return {
          ...
          incompleteMonthDeduction: r.incompleteMonthDeduction ?? existing?.incompleteMonthDeduction,
          ...
          grossPay: r.grossPay ?? existing?.grossPay,
          calculationVersion: r.calculationVersion ?? existing?.calculationVersion,
    ...
    async function loadData() {
      try {
        ...
        setPayrollRecords2026(uniquePayrollRecords.map((r: any) => ({
          ...
          incompleteMonthDeduction: Number(r.incompleteMonthDeduction ?? r.prorationDeduction ?? 0),
