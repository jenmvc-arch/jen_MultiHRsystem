...
function initializeDatabase() {
  ...
  var schema = {
    ...
    payroll_records_2026: ["id", "employeeEmail", "payrollMonth", "payrollYear", "basicSalary", "allowanceGeneral", "allowanceTransport", "allowanceParking", "allowanceMeal", "allowanceAccommodation", "allowancePhone", "overtime", "bonusAmount", "bonusDesc", "commissionAmount", "commissionDesc", "backPayAmount", "backPayDesc", "awsAmount", "awsDesc", "compensationAmount", "compensationDesc", "reimbursementAmount", "reimbursementDesc", "unpaidLeave", "incompleteMonthDeduction", "grossPay", "calculationVersion", "deductionInLieu", "deductionCp38", "deductionOthers", "deductionOthersDesc", "actualPCBDeducted", "epfEmployee", "epfEmployer", "socsoEmployee", "socsoEmployer", "lindung24Employee", "eisEmployee", "eisEmployer", "hrdCorp", "netPay", "paymentDate", "payslipDescriptions", "payoutKind", "isSeparatePayout", "statutoryTreatment", "payoutTitle", "payoutDescription", "lineNotes", "documentType", "compensationLabel", "displaySettingsSnapshot", "createdAt", "updatedAt"],
